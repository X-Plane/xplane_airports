...
class TestAptDat(TestCase):
    ...
    def test_empty_metadata_entries(self):
        # Tyler notes: As of 11.50, we actually want to preserve empty metadata keys
        ytwb_empty_vals = """A
                            1000 Generated by WorldEditor
                            ...
                            110 2 1.00 190.0000 New Taxiway 13
                            """
        ytwb = Airport.from_str(ytwb_empty_vals, 'ytwb.dat')
        self.assertTrue(MetadataKey.ICAO_CODE in ytwb.metadata)
        self.assertTrue(MetadataKey.DATUM_LAT in ytwb.metadata)
        self.assertTrue(MetadataKey.ICAO_CODE in ytwb.metadata)
        self.assertEqual(ytwb.metadata[MetadataKey.IATA_CODE], 'FHGWGADS')

        strval = str(ytwb)
        self.assertTrue('datum_lat' in strval)
        self.assertTrue('gui_label' in strval)
        self.assertTrue('icao_code' in strval)
    ...
    def test_file_reading(self):
        ...
        self.assertEqual(len(apts), 32)
        self.assertTrue('LELL' in apts)
        self.assertTrue('5WI4' in apts)
        self.assertTrue('TN04' in apts)
        self.assertTrue('6NY6' in apts)
        self.assertTrue('XRP001U' in apts)
