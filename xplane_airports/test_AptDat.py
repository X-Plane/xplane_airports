...
class TestAptDat(TestCase):
    def setUp(self):
        ...
        self.apt_dat_multi_string = """A
                                ...
                                100 29.87 1 0 0.25 0 2 0 11 -27.54021531  151.91198836    0    0 2 0 1 0 29 -27.54479369  151.92212245    0    0 2 0 1 0
    ...
    def test_get_apt_ICAO_codes(self):
    ...
    def test_get_elevations_feet_amsl(self):
        self.assertAlmostEqual(list(apt.elevation_ft_amsl for apt in self.multi_parser), [2084, 39, 978, 1235], "Elevations do not match")

    def test_get_apt_lats(self):
        lats = list(apt.latitude for apt in self.multi_parser)
        self.assertAlmostEqual(lats[0], -27.54021531, "Latitudes do not match")
        self.assertAlmostEqual(lats[1], -24.06946550, "Latitudes do not match")
        self.assertAlmostEqual(lats[2], -38.23172467, "Latitudes do not match")
        self.assertAlmostEqual(lats[3], -19.63589237, "Latitudes do not match")

    def test_get_apt_longs(self):
        longs = list(apt.longitude for apt in self.multi_parser)
        self.assertAlmostEqual(longs[0], 151.91198836, "Longitudes do not match")
        self.assertAlmostEqual(longs[1], -046.82978069, "Longitudes do not match")
        self.assertAlmostEqual(longs[2], -072.48881639, "Longitudes do not match")
        self.assertAlmostEqual(longs[3], 134.16954220, "Longitudes do not match")
    ...
    def test_get_elevation_feet_amsl(self):
        ...
        self.assertAlmostEqual(self.single_parser.elevation_ft_amsl, 695.0, error_msg)
        self.assertAlmostEqual(self.single_parser1.elevation_ft_amsl, 20.0, error_msg)
        self.assertAlmostEqual(self.single_parser_from_multi.elevation_ft_amsl, 978, error_msg)

    def test_get_apt_lat(self):
        error_msg = "Latitude does not match"
        self.assertAlmostEqual(self.single_parser.latitude, 50.90432000, error_msg)
        self.assertAlmostEqual(self.single_parser1.latitude, 42.37428432, error_msg)
        self.assertAlmostEqual(self.single_parser_from_multi.latitude, -38.23172467, error_msg)

    def test_get_apt_long(self):
        error_msg = "Longitude does not match"
        self.assertGreater(self.single_parser.longitude, 9.23946100 - 0.01, error_msg)
        self.assertLess(self.single_parser.longitude, 9.23946100 + 0.01, error_msg)

        self.assertGreater(self.single_parser1.longitude, -071.01792575 - 0.01, error_msg)
        self.assertLess(self.single_parser1.longitude, -071.01792575 + 0.01, error_msg)

        self.assertAlmostEqual(self.single_parser_from_multi.longitude, -072.48881639, error_msg)
